...
class FormularioClientes:
 ...
 def Formulario():
    try:
        ...
        labelSexo = Label(groupBox, text = "Apellidos:", width = 13, font = ("arial", 12)).grid(row = 3, column = 0)
        seleccion_sexo = tk.StringVar()
        combo = ttk.Combobox(groupBox, values = ["Masculino", "Femenino"], textvariable = seleccion_sexo)
        ...
        groupBox = LabelFrame(base, text = "Total del personal", padx = 5, pady = 5, )
